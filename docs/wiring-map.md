...
| Çarpma sensörü | GPIO26 (öneri) | ⏳ firmware eklentisi | Dijital giriş, refleks-stop |
| Ultrasonik ×4 | trig+echo ×4 (8 pin) | ⏳ firmware eklentisi | ⚠️ HC-SR04 echo **5V** → 3.3V'a bölücü gerekir |
...
- [ ] Ultrasonik ESP32'de mi Pi'da mı — öneri ESP32 (refleks), protokol
      genişletmesi gerekir. Karar netleşince firmware'e eklerim.
